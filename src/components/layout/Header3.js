              ...
              <div className="col-lg-12">
                ...
                <div className="site-navigation d-flex align-items-center justify-content-between">
                  ...
                  <div className="header_btn">
                    <a
                      className="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-border
                    ...
                    >
                      ...
                      <a href={process.env.PUBLIC_URL + '/register'}>sign up </a>
              ...
              <div className="col-md">
                <label>
                  <input
                    type="text"
                    id="locations"
                    placeholder="Locations (e.g. City, Counter)"
                  />
                </label>
              </div>
              <div className="col-md">
