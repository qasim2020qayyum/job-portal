...
const BlogClassic = () => {
  return (
    <div className="site-main">
      ...
      {/* PageHeader */}
      <PageHeader title="blog classic" breadcrumb="blog" />
      {/* PageHeader end */}
                ...
                <div className="ttm-blog-classic-content">
                  <div className="ttm-post-entry-header">
                    <div className="post-meta">
                      <span className="ttm-meta-line category">
                        <i className="ti ti-folder"></i>business
                      </span>
                      <span className="ttm-meta-line byline">
                        <i className="ti ti-user"></i>John Doe
                      </span>
                    ...
                    <header className="entry-header">
                      <h2 className="entry-title">
                        <a href={process.env.PUBLIC_URL + '/blog_details'}>
                          How Sources Utilize Their Sleuthing Skills Beyond Work
                        </a>
                      </h2>
                    </header>
                  </div>
                  <div className="entry-content">
                    <div className="ttm-box-desc-text">
                      <p>
                        If you are curious how else you could help yourself or others with sourcing abilities outside of the normal requisition- and
                        pipelining-related works, your colleagues have recently been provided an ingenious inspiration. It used to be the third person
                        who was able to ask him a question out!
                      </p>
                    </div>
                    <div className="ttm-blogbox-footer-readmore">
                      <a className="ttm-btn ttm-btn-size-md btn-inline ttm-btn-color-dark" href={process.env.PUBLIC_URL + '/blog_details'}>
              ...
              <article className="post ttm-blog-classic clearfix">
                ...
                <div className="ttm-post-featured-wrapper ttm-featured-wrapper">
                  <div className="ttm-post-featured">
                    <img
                      className="img-fluid"
                      src="https://via.placeholder.com/1200x800?text=1200x800+blog-02-1200x800.jpg"
                      alt="blog-img"
                    />
                    <div className="ttm-box-post-date">
                      <span className="ttm-entry-date">
                ...
                <div className="ttm-blog-classic-content">
                  ...
                  <div className="entry-content">
                    <div className="ttm-box-desc-text">
                      <p>
                        The Microsoft Outlook and various dedicated feed reader apps exist, and there’s even paid competitive intelligence software, but
                        what if you wanted a free central repository built up over time that could be shared with certain colleagues? Personnel changes
                        worthwhile for talent sourcing
                      </p>
                    </div>
                    <div className="ttm-blogbox-footer-readmore">
                      <a className="ttm-btn ttm-btn-size-md btn-inline ttm-btn-color-dark" href={process.env.PUBLIC_URL + '/blog_details'}>
              ...
              <article className="post ttm-blog-classic clearfix">
                ...
                <div className="ttm-post-featured-wrapper ttm-featured-wrapper">
                  <div className="ttm-post-featured">
                    <img
                      className="img-fluid"
                      src="https://via.placeholder.com/1200x800?text=1200x800+blog-04-1200x800.jpg"
                      alt="blog-img"
                    />
                    <div className="ttm-box-post-date">
                      <span className="ttm-entry-date">
                ...
                <div className="ttm-blog-classic-content">
                  ...
                  <div className="entry-content">
                    <div className="ttm-box-desc-text">
                      <p>
                        80% of global HR leaders reveal that their interviewing and hiring process is now fully remote. Find more trends and actionable
                        insights in this report to learn how you can invest in a better remote hiring process today. The world and receive over 140 million
                ...
                <aside className="widget widget-banner">
                  <div className="ttm-col-bgcolor-yes bg-theme-DarkColor text-theme-WhitColor col-bg-img-seven ttm-col-bgimage-yes p-30 pb-50 pt-45">
                    <div
                      ...
                      style={{ backgroundImage: 'url(https://via.placeholder.com/875x583?text=875x583+col-bgimage-7.jpg)' }}
                    >
