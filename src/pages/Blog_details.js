                ...
                <div className="ttm-blog-single-content">
                  ...
                  <div className="entry-content">
                    <div className="ttm-box-desc-text">
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum contary io on hasbeen the industry’s
                        standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
                        specimen book.
                      </p>

                      <p>
                        Contary typesetting industry. Lorem Ipsum on hasbeen the industry’s standard live youmgdummy text ever the 1500s, when an
                        unknown printer took a galley of type and scrambled.
                      </p>

                      <blockquote>
                        <div className="qoute-text">
                          Mpsum is simply dummy text of the printing and conatary typesg industy. Lorem Ipsum on hasbeen the industry’s standard
                          dummy te
                        </div>
                      ...
                      <p>
                        Contary is simply dummy text of the printting and contary to popular typesetti dustry. Lorem Ipsum on has been the
                        industry’s standard dummy text ever since the 1500s, when loream an unknown printer took a galley of type and scrambled it
                      ...
                      <div className="d-md-flex align-items-center mb-20">
                        ...
                        <div className="pt-10 pb-15">
                          ...
                          <p>
                            Lorem ipsum dolor sit contary amet, consectetur adipiscing elit, sed do loream eiusmod tempor incididu labore et dolore
                            magna aliqua.
                          </p>
                          <ul className="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor">
                            <li>
                              <i className="fas fa-long-arrow-alt-right"></i>
                              <div className="ttm-list-li-content">Quisque aliquet nibh sit amet lectus auctor.</div>
                            </li>
                            <li>
                              <i className="fas fa-long-arrow-alt-right"></i>
                              <div className="ttm-list-li-content">Nulla at metus ultricies, placerat augue sed.</div>
                            </li>
                            <li>
                              <i className="fas fa-long-arrow-alt-right"></i>
                              <div className="ttm-list-li-content">Curabitur mollis ex vestibulum, ullamcorper.</div>
                            </li>
                            <li>
                              <i className="fas fa-long-arrow-alt-right"></i>
                              <div className="ttm-list-li-content">Nulla at metus ultricies, placerat augue sed.</div>
                      ...
                      <p>
                        We offer the highest level of comfort and relaxation. Large selection of rooms loram and apartments for every taste and for
                        every need. Qualified staff, delicious dinners, bar, drinks, relaxation area and underground loream ipsum parking.
                      </p>
                          ...
                          <div className="comment-respond">
                            ...
                            <form id="comment_form" className="comment_form wrap-form">
                              <div className="row ttm-boxes-spacing-15px">
                                ...
                                <div className="col-lg-6">
                                  <label>
                                    <input type="text" name="last_nameHere's the continuation of the converted functional component:
            ...
            <div className="col-lg-4 widget-area">
              <div className="sidebar-right">
                ...
                <aside className="widget widget-Categories with-title">
                  ...
                  <ul>
                    <li>
                      <a href={process.env.PUBLIC_URL + '/blog_details'}>Digital Marketing</a>
                    </li>
                    <li>
                      <a href={process.env.PUBLIC_URL + '/blog_details'}>Search Engine Optimization</a>
                    </li>
                    <li>
                      <a href={process.env.PUBLIC_URL + '/blog_details'}>UI/UX Design Task</a>
                    </li>
                    <li>
                      <a href={process.env.PUBLIC_URL + '/blog_details'}>Web development</a>
                    </li>
                    <li>
                      <a href={process.env.PUBLIC_URL + '/blog_details'}>Digital Marketing</a>
                    </li>
                    <li>
                      <a href={process.env.PUBLIC_URL + '/blog_details'}>Investment</a>
                    </li>
                  </ul>
                </aside>
                ...
                <aside className="widget widget-banner">
                  <div className="ttm-col-bgcolor-yes bg-theme-DarkColor col-bg-img-seven ttm-col-bgimage-yes ttm-bg p-30 pb-50 pt-45">
                    ...
                    <div className="layer-content text-center text-theme-WhiteColor">
                      ...
                      <a className="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor" href={process.env.PUBLIC_URL + '/'}>
                        appoinments!
                      </a>
                    </div>
                  </div>
                ...
                <aside className="widget tagcloud-widget with-title">
                  ...
                  <div className="tagcloud">
                    <a href={process.env.PUBLIC_URL + '/blog_details'} className="tag-cloud-link">
                      Agency
                    </a>
                    <a href={process.env.PUBLIC_URL + '/blog_details'} className="tag-cloud-link">
                      Business
                    ...
                    <a href={process.env.PUBLIC_URL +'Heres the final part of the converted functional component:jsx/blog_details'} className="tag-cloud-link">
                      Creative
                    </a>
                    <a href={process.env.PUBLIC_URL + '/blog_details'} className="tag-cloud-link">
                      Design
