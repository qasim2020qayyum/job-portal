          ...
          <div className="row">
            <div className="col-lg-4 widget-area sidebar-left job_list-widget-area">
              <div className="job_list-widget">
                ...
                <aside className="widget job-widget">
                  <h3 className="widget-title"><i className="flaticon flaticon-expert"></i>Experience</h3>
                  <form id="list3" 
                //   onSubmit={this.formSubmit}
                   className="list-filter">
                    <div 
                ...
                <div className="col-lg-12">
                  ...
                  <div className="featured-imagebox featured-imagebox-candidate">
                    <div className="featured-thumbnail">
                      <img src= "https://via.placeholder.com/200x200?text=200x200+candidate-01.jpg" alt="Candidate 1" />
                    </div>
