                  ...
                  <div className="d-sm-flex justify-content-between align-items-center mb_10">
                    ...
                    <div className="social-icons circle mb-10">
                      <ul className="list-inline">
                        ...
                        <li>
                          <a href="#pinterest" rel="noopener" aria-label="pinterest">
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12">
                  <div className="overview-box">
                    ...
                    <div className="desc">
                      <p>
                        Dolor sed viverra ipsum nunc. In ornare quam viverra orci. Id diam maecenas ultricies mi eget
                        mauris pharetra et ultrices. Non diam phasellus vestibulum lorem sed risus ultricies. Lacinia
                        at quis risus sed vulputate odio ut enim blandit. Suspendisse ultrices gravida dictum fusce
                        ut.
                      </p>
                      <p>
