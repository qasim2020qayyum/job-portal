                     ...
                     <div className="featured-desc">
                         <ul className="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor">
                             <li className="pb-0">
                                 ...
                                 <div className="ttm-list-li-content">123 King Street,Melbourne Victoria 5000,New York.</div>
                             </li>
     ...
     <div className="row g-0">
         <div className="col-lg-5">
             ...
             <div className="ttm-bg ttm-col-bgimage-yes col-bg-img-seven ttm-left-span">
                 <div className="ttm-col-wrapper-bg-layer ttm-bg-layer" style={{ backgroundImage: 'url(https://via.placeholder.com/875x583?text=875x583+col-bgimage-7.jpg)' }}></div>
                 <div className="layer-content">
                 </div>
                 <img className="img-fluid col-bg-img-res" src="https://via.placeholder.com/875x583?text=875x583+col-bgimage-7.jpg" alt="bgimage" />
...
{/* padding_zero-section end */} 
      {/* map-section */}
      <section>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5344649.376490554!2d-105.18790339813212!3d39.4391730825603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e0!3m2!1sen!2sin!4v1626439456246!5m2!1sen!2sin" width="100%" height="550"></iframe>
      </section>
      {/* map-section end */}
